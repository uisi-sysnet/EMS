...
Route::middleware(['role:superAdmin,admin'])->group(function () {
    ...
    Route::get('/inventory/stations', [StationController::class, 'index'])->name('stations.index');
    Route::post('/inventory/stations', [StationController::class, 'store'])->name('stations.store');
    Route::delete('/allowed-networks', [ApiKeyController::class, 'destroyIp'])->name('allowed-networks.destroy');
    Route::put('/inventory/stations/{station}', [StationController::class, 'update'])->name('stations.update');
    Route::get('/inventory/stations/{station}/edit', [StationController::class, 'edit'])->name('stations.edit');
    Route::delete('/inventory/stations/{station}', [StationController::class, 'destroy'])->name('stations.destroy');
    Route::post('/inventory/stations/{station_mn}/restore', [StationController::class, 'restore'])->name('stations.restore');
    Route::get('/inventory/stations/{station_mn}/check-data', [StationController::class, 'checkData'])->name('stations.check-data');
