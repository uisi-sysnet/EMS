...
<div class="max-w-5xl mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {{-- Left panel: Instructions + Test button --}}
        <div class="rounded-xl border border-border-700/50 bg-surface-900 p-5 flex flex-col">
        ...
        <form method="POST" action="{{ route('settings.telegram.update') }}"
              class="rounded-xl border border-border-700/50 bg-surface-900 p-5 space-y-5">
            @csrf
            @method('PUT')
