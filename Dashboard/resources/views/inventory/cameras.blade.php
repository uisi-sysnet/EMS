                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
                            ...
                            <div class="flex flex-col">
                                ...
                                <input type="text"
                                    ...
                                    oninput="
                                        ...
                                        v = v.split('.').slice(0, 4).map(p => p.slice(0, 3)).join('.');
                                        this.value = v;
                                    ">
                                @error('ip_address')
                                    <p class="mt-1 text-xs text-munti-red-400">{{ $message }}</p>
                            ...
                            <div class="flex flex-col">
                                ...
                                <div class="flex items-center h-8 px-2.5 border border-border-600 rounded-md bg-surface-900">
                                    ...
                                    <label for="enabled" class="ml-1.5 text-xs text-text-300">
                                        Active
                                    </label>
                                </div>
                                @error('enabled')
                            ...
                            <div class="flex flex-col">
                                ...
                                <button type="submit"
                                    class="w-full h-8 px-3 bg-munti-green-600 hover:bg-munti-green-500 text-text-100 text-xs font-semibold rounded-md transition border border-munti-green-500/30 flex items-center justify-center gap-1.5 whitespace-nowrap">
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        class="w-3.5 h-3.5 shrink-0"
                                        fill="none"
                                        viewBox="0 0 24 24"
                                        ...
                                        <tr class="hover:bg-surface-700/50 transition" data-camera-id="{{ $camera->id }}">
                                            ...
                                            <td class="px-4 py-2.5 whitespace-nowrap text-center">
                                                <div class="flex items-center justify-center gap-1.5">
                                                    {{-- View Button --}}
                                                    <a href="{{ route('inventory.cameras.show', $camera->id) }}"
                                                        class="p-1.5 rounded-lg text-text-400 hover:text-blue-400 hover:bg-surface-700/70 transition-all duration-200 group"
                                                        title="View Camera">
                                                    ...
                                                    {{-- Edit Button --}}
                                                    <a href="{{ route('inventory.cameras.edit', $camera->id) }}"
