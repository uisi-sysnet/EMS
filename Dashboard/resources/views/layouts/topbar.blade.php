            ...
            <div class="flex items-center gap-x-1 sm:gap-x-3">
                ...
                <div class="relative" id="avatar-dropdown">
                    ...
                    <div id="avatar-dropdown-menu"
                        ...
                        <a href="#" class="flex items-center gap-2 px-4 py-2.5 text-sm text-text-400 hover:bg-surface-700 hover:text-radar-400 transition-colors border-t border-border-700">
                            User Management
                        </a>
