        ...
        <div class="h-16 flex items-center justify-between">
            ...
            <div class="hidden xl:flex items-center gap-x-5 lg:gap-x-20 text-sm font-medium">
                @if(session('role') === 'admin' || session('role') === 'superAdmin')
                    ...
                    {{-- Inventory Dropdown --}}
                    <div class="relative group" id="inventory-dropdown-desktop">
                        <button type="button" class="inventory-dropdown-toggle flex items-center gap-x-1 text-text-400 hover:text-text-100 transition-colors py-1 focus:outline-none" aria-expanded="false">
                            Inventory
                        ...
                        <div class="inventory-dropdown-menu absolute left-0 mt-2 w-52 bg-surface-800 rounded-xl shadow-2xl border border-border-700 hidden z-20 overflow-hidden">
            ...
            <div class="flex items-center gap-x-1 sm:gap-x-3">
                ...
                <div class="relative" id="settings-gear-container">
                    ...
                    <div id="settings-gear-dropdown"
                        ...
                        <a href="{{ route('settings.telegram.edit') }}" class="flex items-center gap-2 px-4 py-2.5 text-sm text-text-400 hover:bg-surface-700 hover:text-radar-400 transition-colors border-t border-border-700">
                            Telegram
                        </a>
