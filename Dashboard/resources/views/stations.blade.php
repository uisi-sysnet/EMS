                                        ...
                                        <tr class="hover:bg-surface-700/50 transition">
                                            ...
                                            <td class="px-4 py-2.5 whitespace-nowrap text-center">
                                                <div class="flex items-center justify-center gap-1.5">
                                                    ...
                                                    <!-- Delete Button -->
                                                    <form action="{{ route('stations.destroy', $station->id) }}" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete station {{ $station->station_mn }}? This action cannot be undone.')">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit"
