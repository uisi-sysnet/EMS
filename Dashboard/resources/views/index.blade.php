                ...
                <div class="lg:col-span-2 bg-surface-800 rounded-xl shadow border border-border-700 overflow-hidden">
                    ...
                    <div id="system-summary-body">
                        ...
                        <div class="px-3 sm:px-4 pb-3 sm:pb-4">
                            <div class="bg-surface-900/60 border border-border-700 rounded-lg px-4 py-3 flex items-center justify-between gap-4">
                                <span class="text-sm font-semibold tracking-wider text-text-200 uppercase select-none">
                                    Network Ports
                                </span>
                                <div id="summary-network-ports" class="flex items-end gap-5 overflow-x-auto">
                                    @forelse($systemSummary['network']['ports'] as $port)
                                        <div class="flex flex-col items-center gap-1.5 shrink-0">
                                            <span class="text-[10px] text-text-400 uppercase tracking-wide" title="{{ $port['name'] }}">
                                                {{ $port['name'] }}
                                            </span>
                                            ...
                                            <span class="text-[10px] text-text-500 max-w-[72px] truncate text-center"
