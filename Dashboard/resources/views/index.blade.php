                    ...
                    <div id="system-summary-body">
                        <div class="p-3 sm:p-4 grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-1.5 text-xs">
                            ...
                            <div class="flex items-center gap-4 min-w-0">
                                <span class="text-[10px] uppercase tracking-wider text-text-400 shrink-0 me-30">Network Ports</span>
                ...
                portsEl.innerHTML = summary.network.ports.length
                    ? summary.network.ports.map(p => `
                        <div class="flex flex-col items-center gap-1 shrink-0">
                            <span class="text-[9px] text-text-500 uppercase tracking-wide max-w-[90px]" title="${esc(p.name)}">${esc(p.name)}</span>
